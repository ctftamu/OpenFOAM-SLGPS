...
)
{
    ...
    TF_Graph* graph;
     // Load graph
    graph = tf_utils::LoadGraph("./model_EXTRA_PROD_a_0.00000000000075_l_16.pb");

     // Define input operation
    TF_Output input_ph = {TF_GraphOperationByName(graph, "dense_2_input"), 0};

    // Define output operation
    TF_Output output = {TF_GraphOperationByName(graph, "dense_3/Sigmoid"), 0};
